import { SlashCommandBuilder, ChannelType, ButtonStyle, ActionRowBuilder, ButtonBuilder, AttachmentBuilder, EmbedBuilder, ChatInputCommandInteraction, GuildChannel, CategoryChannel, Collection, NonThreadGuildBasedChannel, TextChannel } from 'discord.js';
import { SlashCommand } from '../'
import { chromium } from "playwright";
import slugify from "slugify";
import { ACTIVE_PUZZLES_CHANNEL_CATEGORY_ID, PUZZ_WATCHERS_ROLE_ID, OLD_PUZZLES_CHANNEL_CATEGORY_ID } from '../../config';
	...
	try {
		...
		const embed = new EmbedBuilder()
			...
			.addFields(
				...
				{ name: '👨‍💻 Finished by', value: `<@${interaction.member?.user.id}>` },
			)
